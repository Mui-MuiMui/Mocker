...
const COMPONENT_MAP: Record<string, ComponentMapping> = {
  ...
  CraftSwitch: {
    ...
    importName: "Switch",
    propsMap: ["checked", "disabled", "checkedColor", "uncheckedColor", "checkedClassName", "uncheckedClassName", "className"],
    textProp: "label",
    isContainer: false,
  },
  CraftTabs: {
...
const DEFAULT_PROPS: Record<string, Record<string, unknown>> = {
  ...
  CraftSwitch: { label: "Toggle", checked: false, disabled: false, checkedColor: "", uncheckedColor: "", checkedClassName: "", uncheckedClassName: "" },
